...
/*   Updated: 2023/12/07 10:11:47 by jorteixe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->player.down.img = mlx_xpm_file_to_image(data->mlx,
			"./textures/player_up.xpm", &data->player.down.width,
			&data->player.down.height);
	data->player.up.img = mlx_xpm_file_to_image(data->mlx,
			"./textures/player_down.xpm", &data->player.up.width,
			&data->player.up.height);
	data->player.right.img = mlx_xpm_file_to_image(data->mlx,
			"./textures/player_left.xpm", &data->player.right.width,
			&data->player.right.height);
	data->player.left.img = mlx_xpm_file_to_image(data->mlx,
			"./textures/player_right.xpm", &data->player.left.width,
			&data->player.left.height);
	data->ground.img = mlx_xpm_file_to_image(data->mlx, "./textures/ground.xpm",
			&data->ground.width, &data->ground.height);
	data->wall.img = mlx_xpm_file_to_image(data->mlx, "./textures/wall.xpm",
			&data->wall.width, &data->wall.height);
	data->exit.img = mlx_xpm_file_to_image(data->mlx, "./textures/exit.xpm",
			&data->exit.width, &data->exit.height);
	data->collectible.img = mlx_xpm_file_to_image(data->mlx,
			"./textures/collectible.xpm", &data->collectible.width,
	...
	while (data->map.map_array[i] != NULL)
	{
		...
		while (data->map.map_array[i][j] != '\0')
		{
			if (data->map.map_array[i][j] == '1')
				mlx_put_image_to_window(data->mlx, data->win, data->wall.img, j
					* 32, i * 32);
				...
				mlx_put_image_to_window(data->mlx, data->win,
					data->player.up.img, j * 32, i * 32);
			else if (data->map.map_array[i][j] == 'E')
				mlx_put_image_to_window(data->mlx, data->win, data->exit.img, j
					* 32, i * 32);
			else if (data->map.map_array[i][j] == 'C')
				mlx_put_image_to_window(data->mlx, data->win,
					data->collectible.img, j * 32, i * 32);
			j++;
		}
		i++;
	}
